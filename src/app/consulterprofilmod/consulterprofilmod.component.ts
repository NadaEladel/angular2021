...
@Component({
  selector: 'app-consulterprofilmod',
  templateUrl: './consulterprofilmod.component.html',
  styleUrls: ['./consulterprofilmod.component.css']
})
export class ConsulterprofilmodComponent implements OnInit {
