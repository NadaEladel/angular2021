...
@Component({
  selector: 'app-consulterdimmoderateur',
  templateUrl: './consulterdimmoderateur.component.html',
  styleUrls: ['./consulterdimmoderateur.component.css']
})
export class ConsulterdimmoderateurComponent implements OnInit {
